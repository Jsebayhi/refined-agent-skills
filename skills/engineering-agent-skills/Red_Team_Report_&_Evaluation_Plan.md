...
- [ ] Description follows the "Iron-Clad" standard? (Starts with: **"MANDATORY. DO NOT <Action> without calling 'activate_skill' on '<skill-name>' first."**)
- [ ] Description is 600-900 chars?
- [ ] Explicitly links the task (e.g., "write code") to the tool call (`activate_skill`)?
