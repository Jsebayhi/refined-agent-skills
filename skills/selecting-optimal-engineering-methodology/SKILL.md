...
2.  **MANDATORY SUB-SKILL CHAINING:** Once the contract is approved, you MUST deactivate this skill and activate both the **state-management skill** (`authoring-artifact-driven-plans`) and the specific **Engine skill** (Linear or Complex) indicated in the contract.
...
Analyze the request to determine its nature based on the following technical definitions:
...
*   **Complex (Standard/Exploration):** Any task requiring engineering decision-making. This includes implementing new features, multi-step bug investigations, or any change that alters logic flow or creates new files.
...
3.  Activate the **state-management skill** (`authoring-artifact-driven-plans`) and the specific **Engine skill**.
