...
*   **Storage:** `[STEP_ID]_human_intel.md`.
...
*   **Storage:** `[STEP_ID]_autonomous_intel.md`.
...
*   **Stage 1: Discovery Planning.** Upon entry, the agent only decomposes the micro-tasks for Research and Hypothesis Generation. The output of this stage is the Solution Strategy.
...
*   The agent must maintain a `[STEP_ID]_original_goal.md` file.
